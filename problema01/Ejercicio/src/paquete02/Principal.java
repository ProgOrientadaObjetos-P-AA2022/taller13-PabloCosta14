...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        t2.establecerPrecio(1300.2); //1300.2

        Televisor t3 = new Televisor();
        t3.establecerMarca("RIVIERA-29 pulgadas");
        t3.establecerPrecio(2300.5); //2300.5
        ...
        op.establecertotalPrecioTvs(tvs);
        op.establecerlistaMarcasVendidas(tvs);
        op.establecertelevisorMasCaro(tvs);

        System.out.println(op);

        System.out.printf("%s\n", op.obtenerMarcasVendidas());
        System.out.printf("Total Precio de Televisores: %.2f\n",
                op.obtenerPreciototal());

        System.out.printf("Televisor Mas Caro: %.2f\n",
                op.obtenerTelevisorCaro());
